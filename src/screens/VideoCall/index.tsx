...
import { Phone, Camera, Microphone, LeftArrow } from "@/assets/icons";
...
export const VideoCall = () => {
  ...
  return (
    <S.Container>
      ...
      >
        <S.MinimizeButton onPress={handleMinimize}>
        ...
        <S.SelfVideoContainer>
          <S.SelfVideo>
            {isVideoOn ? (
              <Image
                source={{ uri: "https://picsum.photos/seed/user/200/300" }}
                style={{ width: "100%", height: "100%" }}
                resizeMode="cover"
              />
            ) : (
              <S.SelfVideoPlaceholder>Camera Off</S.SelfVideoPlaceholder>
            )}
          </S.SelfVideo>
        </S.SelfVideoContainer>
