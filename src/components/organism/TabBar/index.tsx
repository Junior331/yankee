...
export const TabBar = ({ state, descriptors, navigation }: TabBarProps) => {
  ...
  return (
    <S.Container $Visible={isVisibility} theme={theme === "dark" ? Colors.dark : Colors.light}>
      {orderedRoutes.map((route: { key: string | number; name: any; params: any }) => {
        ...
        const IconComponent = routeIcons[label as keyof typeof routeIcons] || Home;
        ...
        return (
          <S.ContainerIcon
            ...
            bg_color={
              isFocused
                ? theme === "dark"
                  ? Colors.dark.tabBgIconDefault
                  : Colors.light.tabBgIconDefault
                : "transparent"
            }
          >
            <IconComponent
